...
class extensions_checks extends installer
{
	...
	{
		if ( $this->config['system']['debug'] >= 5 ) parent::_setError ( $pagenum, $varnum, '_check_compareValues' );		$return= array ('value' => '', 'isset' => false);
