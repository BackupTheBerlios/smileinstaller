<?php
/* $Id: config.inc.php,v 1.1 2005/02/03 06:03:56 nuhpardon Exp $ */
 ...
 */
$cfg['PmaAbsoluteUri'] = $smic_pma_absolute_uri;
 ...
 */
$cfg['blowfish_secret'] = $smic_blowfish_secret;
...
$i++;
$cfg['Servers'][$i]['host']          = $smic_host; // MySQL hostname or IP address
$cfg['Servers'][$i]['port']          = $smic_port;          // MySQL port - leave blank for default port
$cfg['Servers'][$i]['socket']        = $smic_socket;          // Path to the socket - leave blank for default socket
$cfg['Servers'][$i]['connect_type']  = $smic_connect_type;       // How to connect to MySQL server ('tcp' or 'socket')
$cfg['Servers'][$i]['extension']     = $smic_extension;     // The php MySQL extension to use ('mysql' or 'mysqli')
$cfg['Servers'][$i]['compress']      = $smic_compress;       // Use compressed protocol for the MySQL connection
                                                    // (requires PHP >= 4.3.0)
$cfg['Servers'][$i]['controluser']   = $smic_controluser;          // MySQL control user settings
                                                    // (this user must have read-only
$cfg['Servers'][$i]['controlpass']   = $smic_controlpass;          // access to the "mysql/user"
                                                    // and "mysql/db" tables).
                                                    // The controluser is also
                                                    // used for all relational
                                                    // features (pmadb)
$cfg['Servers'][$i]['auth_type']     = $smic_auth_type;    // Authentication method (config, http or cookie based)?
$cfg['Servers'][$i]['user']          = $smic_user;      // MySQL user
$cfg['Servers'][$i]['password']      = $smic_password;          // MySQL password (only needed
                                                    // with 'config' auth_type)
$cfg['Servers'][$i]['only_db']       = $smic_only_db;          // If set to a db-name, only
                                                    // this db is displayed in left frame
                                                    // It may also be an array of db-names, where sorting order is relevant.
$cfg['Servers'][$i]['verbose']       = $smic_verbose;          // Verbose name for this host - leave blank to show the hostname

$cfg['Servers'][$i]['pmadb']         = $smic_pmadb;          // Database used for Relation, Bookmark and PDF Features
                                                    // (see scripts/create_tables.sql)
                                                    //   - leave blank for no support
                                                    //     DEFAULT: 'phpmyadmin'
$cfg['Servers'][$i]['bookmarktable'] = $smic_bookmarktable;          // Bookmark table
                                                    //   - leave blank for no bookmark support
                                                    //     DEFAULT: 'pma_bookmark'
$cfg['Servers'][$i]['relation']      = $smic_relation;          // table to describe the relation between links (see doc)
                                                    //   - leave blank for no relation-links support
                                                    //     DEFAULT: 'pma_relation'
$cfg['Servers'][$i]['table_info']    = $smic_table_info;          // table to describe the display fields
                                                    //   - leave blank for no display fields support
                                                    //     DEFAULT: 'pma_table_info'
$cfg['Servers'][$i]['table_coords']  = $smic_table_coords;          // table to describe the tables position for the PDF schema
                                                    //   - leave blank for no PDF schema support
                                                    //     DEFAULT: 'pma_table_coords'
$cfg['Servers'][$i]['pdf_pages']     = $smic_pdf_pages;          // table to describe pages of relationpdf
                                                    //   - leave blank if you don't want to use this
                                                    //     DEFAULT: 'pma_pdf_pages'
$cfg['Servers'][$i]['column_info']   = $smic_column_info;          // table to store column information
                                                    //   - leave blank for no column comments/mime types
                                                    //     DEFAULT: 'pma_column_info'
$cfg['Servers'][$i]['history']       = $smic_history;          // table to store SQL history
